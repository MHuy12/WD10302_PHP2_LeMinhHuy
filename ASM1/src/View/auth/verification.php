    ...
    <div class="container-fluid h-custom">
      <div class="row d-flex justify-content-center align-items-center h-100">
        ...
        <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
          <form method="POST" action="?url=ForgotPassController/verifyCode">
            ...
            <div class="form-outline mb-4">
              <input name="code" type="text" id="form3Example3" class="form-control form-control-lg"
                placeholder="Nhập mã xác nhận của bạn" />
              <label class="form-label" for="form3Example3">Mã xác nhận </label>
            </div>
